...
//@property (nonatomic ,strong) UIPageControl *pageControl;//自己改动
...
//              [imageView setContentMode:UIViewContentModeScaleAspectFill];
            ...
            if (i == 0) {
                ...
                _isWebImage==YES?[imageView sd_setImageWithURL:[NSURL URLWithString:array[i - 1]] placeholderImage:[UIImage imageNamed:@"piaoliang"]]:(imageView.image = [UIImage imageNamed:array[i - 1]]);
            }
